...
var file_request_subscribe_for_order_updates_proto_goTypes = []interface{}{
...
func file_request_subscribe_for_order_updates_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_request_subscribe_for_order_updates_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RequestSubscribeForOrderUpdates); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
