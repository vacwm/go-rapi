...
var file_response_cancel_all_orders_proto_rawDesc = []byte{
	...
	0x08, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x72, 0x70, 0x43, 0x6f, 0x64, 0x65,
}
...
var file_response_cancel_all_orders_proto_goTypes = []interface{}{
...
func file_response_cancel_all_orders_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_response_cancel_all_orders_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ResponseCancelAllOrders); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
